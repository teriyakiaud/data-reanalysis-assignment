...
Respiration values in this paper were taken as the difference in dissolved oxygen between the 


```{r}
par(mfrow = c(1,2))
hist(d$Resp.O2, xlab = "Change in Dissolved Oxygen (NPP)", main = "Histogram of NPP")
qqnorm(d$Resp.O2, main = "Net Primary Productivity")
```
